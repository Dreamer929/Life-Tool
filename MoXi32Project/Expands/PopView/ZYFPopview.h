...
-(instancetype)initInView:(UIView *)hostView image:(NSArray*)images rows:(NSArray*)items doneBlock:(void(^)(NSInteger selectIndex))ondoneBlock cancleBlock:(void(^)())cancleBlock;
